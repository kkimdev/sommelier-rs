...
[`virtwl-v0.2.1-r1` prerelease](https://github.com/kkimdev/sommelier-rs/releases/tag/virtwl-v0.2.1-r1).
The `-r1` suffix identifies a rebuild; the underlying Cargo package version
is `0.2.1`.

| Architecture | Binary |
| --- | --- |
| x86_64 | `sommelier_rs_virtwl-v0.2.1-r1-x86_64` |
| aarch64/arm64 | `sommelier_rs_virtwl-v0.2.1-r1-aarch64` |
...
```bash
curl -fLO https://github.com/kkimdev/sommelier-rs/releases/download/virtwl-v0.2.1-r1/sommelier_rs_virtwl-v0.2.1-r1-x86_64
curl -fLO https://github.com/kkimdev/sommelier-rs/releases/download/virtwl-v0.2.1-r1/SHA256SUMS
sha256sum -c SHA256SUMS --ignore-missing
chmod +x sommelier_rs_virtwl-v0.2.1-r1-x86_64
```

For aarch64/arm64, use the `aarch64` asset instead:

```bash
curl -fLO https://github.com/kkimdev/sommelier-rs/releases/download/virtwl-v0.2.1-r1/sommelier_rs_virtwl-v0.2.1-r1-aarch64
curl -fLO https://github.com/kkimdev/sommelier-rs/releases/download/virtwl-v0.2.1-r1/SHA256SUMS
sha256sum -c SHA256SUMS --ignore-missing
chmod +x sommelier_rs_virtwl-v0.2.1-r1-aarch64
```
...
```bash
install -Dm755 ./sommelier_rs_virtwl-v0.2.1-r1-x86_64 \
...
git tag -a virtwl-v0.2.1-r1 personal/virtwl -m "Release virtwl-v0.2.1-r1"
git push personal refs/tags/virtwl-v0.2.1-r1
```
